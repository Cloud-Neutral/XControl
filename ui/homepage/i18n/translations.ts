    ...
    auth: {
      ...
      login: {
        ...
        alerts: {
          ...
          invalidCredentials: 'Incorrect username or password. Please try again.',
          userNotFound: 'We could not find an account with that username.',
          emailNotVerified: 'Check your inbox for the verification code before signing in.',
          genericError: 'We could not sign you in. Please try again later.',
          mfa: {
            ...
            recoveryCodes: 'Save these recovery codes in a secure place: {codes}',
          },
        },
      },
    },
      ...
      login: {
        ...
        alerts: {
          ...
          mfa: {
            ...
            recoveryCodes: '请妥善保存以下恢复码：{codes}',
          },
        },
      },
    },
