    ...
    userCenter: {
      ...
      mfa: {
        ...
        guide: {
          ...
          step1Description:
            'Search for “Google Authenticator” in your app store and install it to get started.',
          step1Ios: 'iOS / Android: Search for “Google Authenticator” in the App Store or Google Play and install it.',
          step1Android: '',
          step2Title: '2. Scan the QR code to bind Google Authenticator',
          step2Description: 'Open Google Authenticator and scan the QR code to add your account.',
    ...
    userCenter: {
      ...
      mfa: {
        ...
        guide: {
          ...
          step1Ios: 'iOS / Android：在 App Store 或 Google Play 搜索 “Google Authenticator” 并安装。',
          step1Android: '',
          step2Title: '2 打开验证器扫描二维码完成绑定',
          step2Description: '启动 Google Authenticator 并扫描右侧二维码，将账户添加到应用中。',
